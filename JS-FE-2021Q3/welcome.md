...
## Введение 
<details>
  <summary>1. Обзорная информация по курсу и школе</summary>

- Лендинг курса https://rs.school/js/  
- Документация по школе https://docs.rs.school/#/
- Структура JS/FE курса https://github.com/rolling-scopes-school/tasks/blob/master/roadmap.md
- [Чаты для студентов в Discord и telegram](https://docs.rs.school/#/rs-school-chats) 
...
- Статистика текущего набора:
    ...
    - 920 чел после 2х месяцев
</details>

<details>
  <summary>2. Что такое менторинг в RS School?</summary>
...
#### Активности ментора это:
   ...
   - проверка 10+ PR (пять заданий), обсуждение результатов со студентами. Описание процесса review - https://docs.rs.school/#/pull-request-review-process
...
<details>
  <summary>3. Алгоритм распределения студентов по менторам</summary>
...
### Сегодня вам необходимо:
  - Подтвердить вашу регистрацию на курс, если еще не подтверждали - https://app.rs.school/course/mentor/confirm?course=js-fe-2021Q3 (Можно сабмитать несколько раз, сохраняется последний вариант)
...
### Учебная программа
  ...
  - Второй этап обучения - [stage#2](https://github.com/rolling-scopes-school/tasks/tree/master/stage2) (23 ноября - 1 марта 2022)
  - Требования к Junior - [тут](https://github.com/rolling-scopes-school/tasks/blob/master/stage0/modules/js-fe-developer/js-l1-position-requirements.md)
